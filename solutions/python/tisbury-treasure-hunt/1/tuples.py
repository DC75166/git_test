...
def compare_records(azara_record, rui_record):
    ...
    pass
    azara_crdnt = convert_coordinate(azara_record[1])
    return azara_crdnt in rui_record
...
def create_record(azara_record, rui_record):
    ...
    if(compare_records(azara_record, rui_record)):
        coordinate_group = azara_record + rui_record
...
def clean_up(combined_record_group):
    ...
    pass
    report = []
    for tuple1 in combined_record_group:
            new_tuple = (tuple1[0],tuple1[2],tuple1[3],tuple1[4])
            report.append(str(new_tuple))
